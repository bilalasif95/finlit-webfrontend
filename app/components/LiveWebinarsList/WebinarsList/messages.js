/*
 * Webinars List Messages
 *
 * This contains all the text for the Webinars List component.
 */
import { defineMessages } from 'react-intl';

export const scope = 'boilerplate.components.WebinarsList';

export default defineMessages({
  WebinarsList: {
    id: `${scope}.WebinarsList`,
    defaultMessage: 'Live Webinars List',
  },
  CourseTitle: {
