...
function TwoFAAuthentication(props) {
  ...
  return (
    <Wrapper>
      {stepOne && <div className="step_one">
      ...
      {stepTwo && <div className="step_two">
        <div className="security_verify">
          <h4>
        ...
        <div className="form_footer">
          <div className="bottom_btns">
            <Button className="btn_save" onClick={handleStepOneClose}>
              <FormattedMessage {...messages.Cancel} />
            </Button>
            <Button
              className="btn_submit"
      ...
      {stepThree && <div className="step_three">
        <div className="security_verify">
          <h4>
        ...
        <div className="form_footer">
          <div className="bottom_btns">
            <Button className="btn_save" onClick={handleStepTwoClose}>
              <FormattedMessage {...messages.Cancel} />
            </Button>
            <Button
              className="btn_submit"
      ...
      {stepFour && <div className="step_four">
        ...
        <div className="form_footer">
          <div className="bottom_btns">
            <Button className="btn_save" onClick={handleStepThreeClose}>
              <FormattedMessage {...messages.Cancel} />
            </Button>
            <Button
              className="btn_submit"
      ...
      {stepFive && <div className="step_five">
