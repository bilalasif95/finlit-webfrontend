...
function EditQuiz(props) {
  ...
  const updateQuestionHandler = (questionIndex, lessonIndex) => {
    ...
    lessonItem.quiz.savedQuestions[questionIndex].question =
      lessonItem.quiz.savedQuestions[questionIndex].editableTitle;
    setLessonsList(lessonsArray);
  };
  ...
  const questionsChangeHandler = (e, questionIndex, lessonIndex) => {
    const lessonsArray = _.cloneDeep(lessonsList);
    const lessonItem = lessonsArray[lessonIndex];
    lessonItem.quiz.savedQuestions[questionIndex][e.target.name] =
      e.target.value;
            ...
            <Col lg={12} md={12} sm={12} xs={12}>
              <FormGroup className="mb-3">
                ...
                <Input
                  ...
                  readOnly={readOnly}
                  onChange={e =>
                    questionsChangeHandler(e, questionIndex, lessonIndex)
                  }
              ...
              <div className="sec_footer mt-4">
                <div className="bottom_btns">
                  <Button
                    className="btn_back"
                    onClick={() =>
                      cancelQuestionHandler(questionIndex, lessonIndex)
                    }
                  >
                    Cancel
                  </Button>
                  <Button
                    ...
                    className="btn_save"
                    onClick={() =>
                      updateQuestionHandler(questionIndex, lessonIndex)
                    }
                  >
                    Save Question
                  </Button>
