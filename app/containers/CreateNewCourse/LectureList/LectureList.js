...
function LectureList(props) {
  ...
  const cancelLectureHandler = (lectureIndex, lessonIndex) => {
    ...
    lessonItem.savedLectureList[lectureIndex].editableTitle =
      lessonItem.savedLectureList[lectureIndex].title;
    lessonItem.savedLectureList[lectureIndex].editableLectureVideo =
      lessonItem.savedLectureList[lectureIndex].lectureVideo;
    lessonItem.savedLectureList[lectureIndex].editableFileSelected =
      lessonItem.savedLectureList[lectureIndex].fileSelected;
  ...
  const deleteLecturehandler = async (lectureIndex, lessonIndex, id) => {
    ...
    try {
      ...
      if (
        lessonItem.lectureList.length === 0 &&
        lessonItem.savedLectureList.length === 1
      ) {
      ...
      <Row>
        <Col lg={12}>
          <div className="custom_accordin">
            {res.savedLectureList.length > 0 &&
              res.savedLectureList.map((item, i) => (
                <div key={i} className="accordin_item">
                  <div className="accordin_header">
                    ...
                    <div className="action_btns">
                      ...
                      <Button
                        disabled={loading}
                        onClick={() =>
                          deleteLecturehandler(i, lessonIndex, item.id)
                        }
                      >
                        <MdDelete />
                      </Button>
                  ...
                  {res.savedLectureList[i].readView === true && (
                  ...
                  {res.savedLectureList[i].editView === true && (
                    <div className="accordin_content">
                      <div className="section_in">
                        <Row>
                          <Col lg={6}>
                            <FormGroup>
                              ...
                              <input
                                ...
                                onChange={e =>
                                  addLectureChangeHandler(e, i, lessonIndex)
                                }
                            ...
                            <div className="sec_footer">
                              <div className="bottom_btns">
                                <Button
                                  className="btn_back"
                                  onClick={() =>
                                    cancelLectureHandler(i, lessonIndex)
                                  }
                                >
                                  Cancel
                                </Button>
