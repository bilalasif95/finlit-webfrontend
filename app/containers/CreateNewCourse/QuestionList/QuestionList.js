...
function QuestionList(props) {
  ...
  const deleteQuestionHandler = (questionIndex, lessonIndex) => {
    ...
    if (
      lessonItem.quiz.questions.length === 0 &&
      ...
      <Row>
        <Col lg={12}>
          <div className="custom_accordin">
            {res.quiz.savedQuestions.length > 0 &&
              res.quiz.savedQuestions.map((item, i) => (
                <div key={i} className="accordin_item">
                  <div className="accordin_header">
                    ...
                    <div className="action_btns">
                      <Button>
                        <FiEdit3
                          onClick={() =>
                            editToggleQuestionHandler(i, lessonIndex)
                          }
                        />
                      </Button>
                      <Button
                  ...
                  {res.quiz.savedQuestions[i].readView === true && (
                  ...
                  {res.quiz.savedQuestions[i].editView === true && (
                    <div className="accordin_content">
                      <div className="section_in">
                        <EditQuiz
                          lessonIndex={lessonIndex}
