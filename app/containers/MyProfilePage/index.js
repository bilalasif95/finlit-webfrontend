            ...
            <Col lg={3} md={4} sm={12} xs={12}>
              <div className="profile_sidebar">
                <div className="pro_img">
                  ...
                  <Label> <FormattedMessage {...messages.ChangeProfile} />
                    <Input type="file" />
                  </Label>
                </div>
                <Nav tabs>
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => { toggle('1'); }}
                    >
                      <BiUserCircle /> <FormattedMessage {...messages.EditProfile} />
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => { toggle('2'); }}
                    >
                      <BiLock /> <FormattedMessage {...messages.ChangePassword} />
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => { toggle('3'); }}
                    >
                      <RiKeyLine /> <FormattedMessage {...messages.TwoFAuth} />
                    </NavLink>
                  </NavItem>
                </Nav>
              </div>
